      ...
      <div class="col-md-5 col-lg-4 col-xl-3 mt-3 mt-md-0">
        <form action="{{ route('usuarios.index') }}">
          ...
          <div class="form-group position-relative search_content">
            ...
            <input type="text" name="query" id="search_box" class="form-control ms-auto" placeholder="Buscar usuario..." 
...
<script>
  $(document).ready(function(){
    ...
    function load_data(page, query = ''){
      $.ajax({
        url:"/usuarios/api/search?page="+page+"&query="+query,
    ...
    editButtons.forEach(button => {
      button.addEventListener('click', function(e) {
        ...
        setModalData(user)
        let url = '{{ route('usuarios.update', ':alumno') }}';
