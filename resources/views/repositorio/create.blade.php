      	...
      	@auth('alumno')
      		<form method="POST" id="register-repository" action="/repositorios/registrar" enctype="multipart/form-data">
				...
				<div class="form__field">
					...
					<input type="text" name="nombre_repositorio" class="form__input">
				</div>
				<div class="form__field">
					<label for="description" class="form__label">Descripción</label>
					<textarea name="descripcion" class="form__input"></textarea>
				</div>
				<div class="form__field">
				...
				<div class="form__field">
					...
					<div class="upload-files">
						<div class="project__file">
							<input class="file__input" type="file" id="file" name="archivo[]">
